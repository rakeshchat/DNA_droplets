...
fprintf(fo,"awk \'NR>=%d && NR<=%d\' %s > yimage-%06d.xpm\n",time+1, step1+step1*counter, filename, counter+1);
fprintf(fo,"convert yimage-%06d.xpm yimage-%06d.png\n",counter+1, counter+1);
...
system("sleep 5"); system("convert -delay 14 -loop 1 yimage-*.xpm 1movl52.gif"); system("sleep 5"); system("rm yimage*.*");
