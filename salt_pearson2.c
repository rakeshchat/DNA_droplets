...
double rhor,rhog,rhoy,c,d,e,f,Ei,Ef,dE,diff,temp,igg,irr,irg,ioo=1.0,rot=1,clev=1,ds1,ds2,factor;
...
irg    =-1.5;   //0.2,0.5,1.0,1.5,2.0,2.5,3.0
factor = 1.0;
...
sprintf(out1,"1csaltcor2L%d_%dt%de%dr%dg%dy%dT%dfac%.1frg%.2f",L,qq,pp,ens,rhor1,rhog1,rhoy1,temp1,factor,irg); fq=fopen(out1,"w");
...
fprintf(fq,"%lf    %lf    %lf\n",irg,irr,corr2[Tr-1]/ens/Nr);


fclose(fq); free(corr2);
